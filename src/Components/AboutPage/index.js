    ...
    <div id="about" className="page">
      <div className="aboutPageWrapper">
        <div className="textWrapper">
          <h1>About me</h1>
          <p>Hi, I am a front-end developer based in Birmingham UK. I entered the world of tech thanks to the School of Code bootcamp which I graduated from in April 2021. Since then I have been working as a front-end developer.
